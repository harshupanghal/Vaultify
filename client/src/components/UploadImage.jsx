...
const UploadImage = ({reloadEffect}) => {
    ...
    return ( 
    <div className="h-full w-screen  flex flex-col justify-center items-center gap-6 rounded-lg">
    <p className="font-bold text-3xl text-gray-900 pt-2 md:text-[24px]">
    ...
    {file ? (
      <button
        ...
        disabled={loading}
        className="border-blue-900 border-dotted p-2 border-2 rounded-md flex flex-col justify-center items-center hover:bg-sky-200"
      >
        <ImageUp />
